 ...
 * @endcode
 */
$settings['hash_salt'] = 'BzkmZA4zL2wYSvxUHPxDOkRWd3hCWI1u1qdVtCytt82GkiTVZZuIoyeT99-Bbf2qR37KXVNlAQ';
...
$databases['default']['default'] = array (
  'database' => 'sharajman_drupal',
  'username' => 'rihan',
  'password' => 'Sharajman2026tyuio',
  'prefix' => '',
  'host' => '192.168.31.36',
  'port' => '3306',
...
$settings['config_sync_directory'] = 'sites/default/files/config_pn4hsodoEnMrvlf92u2ggUr9UuuADfolQe84qNC1QvoxVbZ749mBZEWq2YyDzBYB0SvIJbhUaw/sync';
$config['system.logging']['error_level'] = 'verbose';

/**
 * Increase PHP memory limit for Drupal operations.
 */
if (function_exists('ini_set')) {
  ini_set('memory_limit', '1024M');
}
// $config['smtp.settings']['smtp_on'] = TRUE;
// $config['smtp.settings']['smtp_host'] = 'test.newage.market';
// $config['smtp.settings']['smtp_port'] = '465';
// $config['smtp.settings']['smtp_protocol'] = 'TLS';
// $config['smtp.settings']['smtp_username'] = 'dev@box.sharajman.com';
// $config['smtp.settings']['smtp_password'] = 'Dev1Sharajman349vb';
// $config['smtp.settings']['smtp_from'] = 'dev@box.sharajman.com';
// $config['smtp.settings']['smtp_fromname'] = 'Sharajman Technologies';